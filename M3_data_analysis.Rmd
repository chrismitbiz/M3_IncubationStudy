...
# nMDS of peak area of soil extracts (hexane:acetone 1:1)  
Peaks areas were normalised to internal standard (DDD)
```{r phyloseqnmds, message=FALSE, echo = FALSE, warning = FALSE, results=FALSE}
theme_set(theme_bw())  
xaxis = c(-0.4, 0.4)
